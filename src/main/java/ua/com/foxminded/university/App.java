...
public class App 
{
    public static void main( String[] args )
    {
        ...
        System.out.println();
        mathClass_seminar.display();
        mathClass_lecture.display();
        physicClass_seminar.display();
        physicClass_lecture.display();
        statisticClass_seminar.display();
        statisticClass_lecture.display();
